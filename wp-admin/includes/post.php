...
function _wp_post_thumbnail_html( $thumbnail_id = null, $post = null ) {
	...
	$set_thumbnail_link = '<p>Image dimensions is 4 x 3:<br/>1024 x 672, 800 x 525, 640 x 420, 480 x 315, 320 x 210<br/>Minimum size: 250 x 164 </p><p class="hide-if-no-js"><a title="' . esc_attr__( 'Set featured image' ) . '" href="%s" id="set-post-thumbnail" class="thickbox">%s</a></p>';
